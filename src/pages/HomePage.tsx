    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 text-center max-w-3xl">
          <h1
            className="text-4xl md:text-5xl font-bold mb-6 leading-tight drop-shadow-xl"
            style={{ textShadow: '2px 2px 6px rgba(0,0,0,0.7)' }}
          >
            มีอะไรกิน?
          </h1>
          <p
            className="text-xl md:text-2xl text-white text-opacity-90 leading-relaxed mb-8"
